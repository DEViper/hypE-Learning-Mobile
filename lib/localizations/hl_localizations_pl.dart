...
class HLLocalizationsPL implements HLLocalizations {
  const HLLocalizationsPL();
  ...
  /// App
  @override
  String get appName => 'Hype-Learning';

  @override
  String get appTitle => 'Hype-Learning';
  ...
  static Future<HLLocalizations> load(Locale locale) {
    return SynchronousFuture<HLLocalizations>(const HLLocalizationsPL());
  }

  static const LocalizationsDelegate<HLLocalizations> delegate =
      HLLocalizationsDelegate();
}
